def UPSTREAM_PROJECTS_LIST = [ "Mule-runtime/metadata-model-api/1.2.2-JANUARY-DRY-RUN",
                               "Mule-runtime/mule-api/1.2.2-JANUARY-DRY-RUN",
                               "Mule-runtime/mule-extensions-api/1.2.2-JANUARY-DRY-RUN",
                               "Mule-runtime/mule-maven-client/1.4.2-JANUARY-DRY-RUN" ]
