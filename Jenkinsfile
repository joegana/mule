def UPSTREAM_PROJECTS_LIST = [ "Mule-runtime/metadata-model-api/1.2.1-JANUARY-DRY-RUN",
                               "Mule-runtime/mule-api/1.2.1-JANUARY-DRY-RUN",
                               "Mule-runtime/mule-extensions-api/1.2.1-JANUARY-DRY-RUN",
                               "Mule-runtime/data-weave/master",
                               "Mule-runtime/mule-maven-client/1.4.0-JANUARY-DRY-RUN" ]
